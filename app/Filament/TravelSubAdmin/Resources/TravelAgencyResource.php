...
use App\Filament\TravelSubAdmin\Resources\TravelAgencyResource\Pages;
use App\Filament\TravelSubAdmin\Resources\TravelAgencyResource\RelationManagers;
...
class TravelAgencyResource extends Resource
{
    ...
    {
        $admin = Auth::user();
        return parent::getEloquentQuery()->where('id', $admin->travel_agency_id);
    }
}
