...
use App\Filament\HotelAdmin\Resources\HotelImageResource\Pages;
use App\Filament\HotelAdmin\Resources\HotelImageResource\RelationManagers;
...
class HotelImageResource extends Resource
{
    ...
    {
        return parent::getEloquentQuery()->whereHas('hotel', function (Builder $query) {
