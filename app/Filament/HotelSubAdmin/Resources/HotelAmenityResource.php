...
use App\Filament\HotelSubAdmin\Resources\HotelAmenityResource\Pages;
use App\Filament\HotelSubAdmin\Resources\HotelAmenityResource\RelationManagers;
...
class HotelAmenityResource extends Resource
{
    ...
    {
        $admin = Auth::user();
        return parent::getEloquentQuery()->whereHas('hotels', function (Builder $query) use ($admin) {
