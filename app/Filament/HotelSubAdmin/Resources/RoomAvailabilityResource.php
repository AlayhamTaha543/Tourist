...
use App\Filament\HotelSubAdmin\Resources\RoomAvailabilityResource\Pages;
use App\Filament\HotelSubAdmin\Resources\RoomAvailabilityResource\RelationManagers;
...
class RoomAvailabilityResource extends Resource
{
    ...
    {
        $admin = Auth::user();
        return parent::getEloquentQuery()->whereHas('roomType.hotel', function (Builder $query) use ($admin) {
