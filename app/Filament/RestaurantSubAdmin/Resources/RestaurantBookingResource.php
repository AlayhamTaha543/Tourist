...
use App\Filament\RestaurantSubAdmin\Resources\RestaurantBookingResource\Pages;
use App\Filament\RestaurantSubAdmin\Resources\RestaurantBookingResource\RelationManagers;
...
class RestaurantBookingResource extends Resource
{
    ...
    {
        $admin = Auth::user();
        return parent::getEloquentQuery()->whereHas('restaurant', function (Builder $query) use ($admin) {
