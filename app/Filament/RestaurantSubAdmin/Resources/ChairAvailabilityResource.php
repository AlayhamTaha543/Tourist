...
use App\Filament\RestaurantSubAdmin\Resources\ChairAvailabilityResource\Pages;
use App\Filament\RestaurantSubAdmin\Resources\ChairAvailabilityResource\RelationManagers;
...
class ChairAvailabilityResource extends Resource
{
    ...
    {
        $admin = Auth::user();
        return parent::getEloquentQuery()->whereHas('restaurantChair.restaurant', function (Builder $query) use ($admin) {
            $query->where('id', $admin->restaurant_id);
        });
    }
}