...
class Booking extends Model
{
    ...
    public function rentalBooking(): HasOne
    {
        return $this->hasOne(RentalBooking::class, 'booking_id', 'id');
    }
    ...
    public function RentBooking()
    {
        return $this->hasOne(RentalBooking::class, 'booking_id');
    }
